        ...
        <nav class="uk-navbar-container" uk-navbar>
            <div class="uk-navbar-right">
                <ul class="uk-navbar-nav">
                   <li class="small-subbar-li"><?= $this->Html->link(__('戻る'), ['action' => 'index'], ['class' => 'uk-button uk-button-primary management-sub-button uk-padding-remove small-subbar-height']) ?></li>
    ...
    <div class="uk-width-3-4@s medium-margin uk-width-1-1 grid-child">
        <div class="grid-next-margin uk-card uk-card-default uk-padding uk-margin-bottom">
            <?= $this->Form->create($managementUser) ?>
                ...
                <?= $this->Form->control('mail', ["label" => "メールアドレス : ", "class" => "uk-input form-width-long"]) ?>
                ...
                <?= $this->Form->control('password', ["label" => "パスワード : ", "class" => "uk-input form-width-long"]) ?>
