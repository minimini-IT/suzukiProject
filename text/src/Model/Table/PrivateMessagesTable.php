 ...
 * @method \App\Model\Entity\PrivateMessage|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\PrivateMessage saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class PrivateMessagesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('private_messages_id');
        $this->setPrimaryKey('private_messages_id');
    ...
    {
        $validator
            ->integer('private_messages_id')
            ->allowEmptyString('private_messages_id', null, 'create');
