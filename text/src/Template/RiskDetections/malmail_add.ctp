...
<div class="riskDetections form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('occurrence_datetime', ["label" => "受信時刻", 'empty' => true]);
            ...
            echo $this->Form->control('attachment', ["label" => "添付ファイルの有無"]);
            echo $this->Form->control('incident_cases_id', ["type" => "hidden", "value" => 1]);
